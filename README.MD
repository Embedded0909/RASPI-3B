...
ApplicationWindow {
    ...
    // Không đặt focus ở đây — ApplicationWindow KHÔNG có property "focus"
    ...
    Item {
        ...
        Keys.onPressed: {
            switch (event.key) {
            case Qt.Key_Left:  box.x -= 10; break;
            case Qt.Key_Right: box.x += 10; break;
            case Qt.Key_Up:    box.y -= 10; break;
            case Qt.Key_Down:  box.y += 10; break;
            }
        }
    }
}
