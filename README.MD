...
ApplicationWindow {
    ...
    Item {
        ...
        Keys.onPressed: {
            ...
            // ----- DI CHUYỂN -----
            case Qt.Key_Left:
                player.x = Math.max(0, player.x - 10)   // Giới hạn bên trái
                break;

            case Qt.Key_Right:
                player.x = Math.min(parent.width - player.width, player.x + 10)  // Giới hạn bên phải
                break;
            ...
            case Qt.Key_Down:
                player.y = Math.min(parent.height - player.height, player.y + 10)
                break;

            // ----- BẮN ĐẠN -----
            case Qt.Key_Space:
                if (!bullet.visible) {   // Chỉ bắn khi viên trước biến mất
                    bullet.visible = true
...
ApplicationWindow {
    ...
    Item {
        ...
        Keys.onPressed: {
            ...
            case Qt.Key_Right:
                player.x = Math.min(parent.width - player.width, player.x + 10)
                break
